	 ...
	 (_display displayCtrl 5502) lbAdd Format["====== RETURNS ======"];
      {
		...
		(_display displayCtrl 5502) lbAdd Format["%2 - [%1]",  _Quantity, _ComponentItemName];
		
        _lbsize = lbSize (_display displayCtrl 5502);
		(_display displayCtrl 5502) lbSetPicture [_lbsize-1,_ComponentItemPicture];
		(_display displayCtrl 5502) lbSetData [_lbsize-1,_Component];
		(_display displayCtrl 5507) ctrlSetText _wSGlobalPic;
