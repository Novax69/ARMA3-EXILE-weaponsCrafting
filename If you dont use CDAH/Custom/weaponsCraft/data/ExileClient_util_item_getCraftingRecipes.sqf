...
private["_forItemClassName", "_foundItems", "_availableRecipes", "_recipeConfig", "_recipeClassName", "_recipeName",
 "_pictureItem", "_picture", "_components", "_tools"];
...
_availableRecipes = (missionConfigFile >> "CfgCraftingRecipes") call Bis_fnc_getCfgSubClasses;
{
	...
	if(_pictureItem isKindOf [_pictureItem, configFile >> "CfgWeapons"]) then
	{
	_picture = getText(configFile >> "CfgWeapons" >> _pictureItem >> "picture");
	}
	else
	{	
